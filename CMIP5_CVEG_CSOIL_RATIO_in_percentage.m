...
Big_cell{Modelnum,1}=(Csoil_After-Csoil_before)./Csoil_before; %delta Csoil,
...
Delta_cveg=(Cveg_After-Cveg_before)./Cveg_before; %Delta Cveg
...
Try=Gap_fill_function(Try); %this is to fill as much NaN as possible, otherwise, average across several models will lost lots of grids.
save(strcat(Model_name,'percentage.mat'),'Try')
end
